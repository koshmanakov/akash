...
const (
	...
	deploymentOvrclkApp  = "./../_run/kube/deployment-global.yaml"
...
// K8sClient provides access to the k8s API
func (f *Fixtures) K8sClient(host string) (cluster.Client, error) {
	ns := "lease" // this is an odd variable which by default is 'lease'
